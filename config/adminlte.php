...
return [
    ...
    */
    ...
    'menu' => [
        ...
        [
            ...
            'submenu' => [
                [
                    ...
                    'url'=> '/admin/dashboard/change-language/en'
                ],
                [
                    'text'=>'Arabic',
                    'icon' => 'flag-icon flag-icon-eg',
                    'url'=> '/admin/dashboard/change-language/ar'
                ]
            ]
        ],
        [
        ...
        [
            'header' => 'admins_authorizations',
            'can' => ['authorizations', 'admins']
        ],
        [
            'text' => 'Authorizations',
