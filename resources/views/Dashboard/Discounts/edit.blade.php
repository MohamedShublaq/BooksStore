...
@section('content_header')
    <h1 class="text-center">{{__('discounts.Edit Discount')}}</h1>
@stop
        ...
        <div class="card-body">
            <form action="{{ route('admin.discounts.update' , $discount->id) }}" method="POST">
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="form-group">
                            <x-adminlte-input name="code" id="code" label="{{__('discounts.Code')}}" value="{{$discount->code}}"
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="form-group">
                            <x-adminlte-input name="quantity" label="{{__('discounts.Quantity')}}" value="{{$discount->quantity}}"
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="form-group">
                            <x-adminlte-input name="percentage" label="{{ __('discounts.Percentage') }}%" value="{{$discount->percentage}}"
                                fgroup-class="mb-4" required>
                            </x-adminlte-input>
                        </div>
                    </div>
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="form-group">
                            <x-adminlte-input name="expiry_date" type="datetime-local" value="{{$discount->expiry_date}}" label="{{__('discounts.Expiry Date')}}"
                                fgroup-class="mb-4" required>
                            </x-adminlte-input>
                        </div>
                    </div>
